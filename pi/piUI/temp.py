...
class pointConfigUI(object):
    def __init__(self, master):
        ...
        for (text, value) in self.valuesX.items():
            ...
            print("set var x value! {}".format(value['var']))
        ...
        for (text, value) in self.valuesY.items():
            ...
            print(self.valuesY)
            value['var'].set(value['value'])
            print("set var y value! {}".format(value['var']))
    ...
    def cleanup(self, axis):
        ...
        print("printing axis {}".format(axis))
        ...
        for key in axis['pointCounts']:
            ...
            self.Console.insert(INSERT, text)
            print("test4")
            print(axis['pointCounts'][key])
            print(axis['pointCounts'][key]['points'])
            print(axis['pointCounts'][key]['total'])
            print("test4 end")
        ...
        print("valuesX start")
        print(self.xAxisPoints)
        print(self.valuesX)
        #print(self.valuesX['points']['name'])
        for (value) in self.valuesX:
            print(self.valuesX.keys())
            print("this is value {}".format(value))
            print("this is valuesX {}".format(self.valuesX[value]))
            
            print(axis['pointCounts']['pointCountUpCeil'][value]) 
        print("valuesX stop")

        

        def setFinalValues(axis, selection, itemValues):
            print("this is setFinalValues !{}!, \n\n!{}!, \n\n!{}!".format(axis, selection, itemValues))
            print(itemValues['points'])
            for (value) in itemValues:
                print("this is value in itemValues {}\n\n".format(value))
...
def stepResolv(total: float, pointCount: int):
    ...
    print(values['pointCounts'])

    #print(values['pointCountUp'])
    #print(values['pointCountDown'])

    #if (intervDist != values['roundUp'] or intervDist != values['roundDown']):
    
    print("test3")
    print(uncorrectedPointCount)
    print("test3 end")
